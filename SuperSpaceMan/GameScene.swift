...
//Summary
//In this chapter learned about SpriteKit is and how to create a new SpriteKit game using Xcode. Created the beginnings of a SpriteKit game starting from scratch and learned about SKNodes and their subclasses and used an SKSpriteNode to add both a background node and a player node.
